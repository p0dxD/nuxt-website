export default {
    home_title_text: 'Home',
    projects_title_text: 'Projects',
    contact_title_text: 'Contact',
    me_job_title_text: 'Software Engineer',
    skills_title_text: 'Skills',
    languages_title_text: 'Languages',
    speaking_table_text: 'Speaking',
    writing_table_text: 'Writing',
    reading_table_text: 'Reading',
    languages_context_text: 'I know both English and spanish. I get to work mostly with English. I would like to eventually get to use both in the workplace.',
